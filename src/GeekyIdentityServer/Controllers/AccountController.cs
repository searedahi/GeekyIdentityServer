...
using GeekyIdentityServer.Models;
using GeekyIdentityServer.Models.Account;
using GeekyIdentityServer.Quickstart;
using GeekyIdentityServer.Services;
using IdentityModel;
...
namespace GeekyIdentityServer.Controllers
{
    /// <summary>
